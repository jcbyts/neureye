...
2. Gaussian 2D (based on Lurz et al., 2020)
"""
...
"""
GAUSSIAN READOUT CORE (modified from Sinz lab https://github.com/sinzlab/neuralpredictors)
"""
...
class Point2DGaussian(Readout):
    ...
    def __init__(self, in_shape=[10,10,10],
        ...
        # the shifter handles eye position as input and outputs shifts --> effectively a calibration
        if shifter:
